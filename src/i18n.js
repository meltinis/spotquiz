...
const MESSAGES = {
  ...
  guest: {
    ...
    quizStartingSoon: 'Quizzen starter snart',
    questionClosed: 'Spørgsmålet er lukket',
    getReady: 'Gør dig klar — svarmuligheder kommer …',
  ...
  admin: {
    ...
    startQuestionIntro: 'Start spørgsmålsintro',
    showIntro: 'Vis intro',
    startFirstQuestionFromIntro: 'Start første spørgsmål (fra intro)',
    closeQuestion: 'Luk spørgsmål',
    nextQuestion: 'Næste spørgsmål',
    nextQuestionIntro: 'Næste spørgsmålsintro',
    ...
    noGameYet:
      'Intet aktivt spil endnu. Brug <strong>Start spørgsmålsintro</strong>, når I er klar.',
    phase: 'Fase',
    ...
    couldNotShowIntro: 'Kunne ikke vise intro.',
  ...
  screen: {
    ...
    colPlayer: 'Spiller',
    colRound: 'Senest',
    colAvgAnswer: 'Gns svartid',
    colTotal: 'Point',
    waitingNextQuestion: 'Venter på næste spørgsmål',
    timerCaption: 'Tid tilbage',
    answerProgressSuffix: 'besvaret',
    top5Heading: 'Top 5',
    top5ColRank: '#',
    top5ColName: 'Navn',
    top5ColPoints: 'Point',
    roundCorrectGuests: 'Rigtige svar i runden',
    roundAvgSpeed: 'Gns. svartid i runde',
  },
  devTools: {
  ...
  gamePhase: {
    waiting: 'Venter',
    intro: 'Intro',
    question_intro: 'Spørgsmålsintro',
    question_reveal_answers: 'Afslører svar',
